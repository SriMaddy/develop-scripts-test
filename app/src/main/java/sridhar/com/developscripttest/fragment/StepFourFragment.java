 ...
 */
public class StepFourFragment extends Fragment implements Animation.AnimationListener {
    ...
    public void onResume() {
        ...
        boolean isAnimated = sharedPreference.isStepFourAnimated(mActivity);
        if(!isAnimated) {
    ...
    private void findViewsById(View view) {
        locationTxt = (EditText) view.findViewById(R.id.location_txt);
    ...
    private void setAnimationToImage() {
        locationImg.setAnimation(animation);
    }
    ...
    public void onAnimationEnd(Animation animation) {
        SharedPreference sharedPreference = new SharedPreference();
        sharedPreference.saveStepFourAnimated(mActivity, true);
    }
